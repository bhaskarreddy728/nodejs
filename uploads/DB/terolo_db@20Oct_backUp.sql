...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2022 at 11:41 AM
...
--
-- Table structure for table `goals_users`
--
...
CREATE TABLE `goals_users` (
  ...
  `goal_user_type` varchar(255) DEFAULT NULL,
  `goal_description` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `goal_target_items`
--

CREATE TABLE `goal_target_items` (
  `id` int(11) NOT NULL,
  `goal_id` int(11) DEFAULT NULL,
  `target_id` int(11) DEFAULT NULL,
  `target_item_name` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `goal_target_users`
--

CREATE TABLE `goal_target_users` (
  `id` int(11) NOT NULL,
  `user_id` int(11) DEFAULT NULL,
  `goal_id` int(11) DEFAULT NULL,
  `target_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `list_checklist`
--

CREATE TABLE `list_checklist` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `list_sub_tasks`
--

CREATE TABLE `list_sub_tasks` (
  `id` int(11) NOT NULL,
  `project_id` int(11) DEFAULT NULL,
  `list_id` int(11) DEFAULT NULL,
  `task_id` int(11) DEFAULT NULL,
  `sub_task_header` varchar(255) DEFAULT NULL,
  `sub_task_description` varchar(255) DEFAULT NULL,
  `sub_task_status` varchar(255) DEFAULT NULL,
  `sub_task_due_date` datetime DEFAULT NULL,
  `sub_task_priority` varchar(255) DEFAULT NULL,
  `status` varchar(255) DEFAULT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `list_task_attachements`
--

CREATE TABLE `list_task_attachements` (
  `id` int(11) NOT NULL,
  `task_id` int(11) DEFAULT NULL,
  `task_attachements` varchar(255) DEFAULT NULL,
...
(1, 'Card', 0, '2022-10-03 11:51:21.167', NULL, '2022-10-03 11:51:21.167'),
(2, 'Cash', 0, '2022-10-03 11:51:33.772', NULL, '2022-10-03 11:51:33.772');
...
CREATE TABLE `tickets` (
  `id` int(11) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `ticketId` int(12) NOT NULL COMMENT 'Populate "id" field value from the same "tickets" table ',
...
INSERT INTO `tickets` (`id`, `ticketId`, `issueTitle`, `ticketCategory`, `ticketPriority`, `companyDetail`, `ticketDescription`, `ticketIssueImage`, `ticketIssueDoc`, `peopleId`, `ticketStatus`, `createdBy`, `createdAt`, `updatedBy`, `updatedAt`) VALUES
(1, 0, 'Taggle error issue', 'product support', 'important', 'Thinroot', 'lkjhgfddsf', 'ticketIssueImage-5eb5ef15-22de-4ead-b4db-7ee526304823.png', 'ticketIssueDoc-60b1b17a-141c-4e61-a9bc-3ace8052bae7.plain', 4, 'InProgress', 0, '2022-10-20 09:33:01.830', NULL, '2022-10-20 09:33:01.830'),
(2, 0, 'Navigate error issue', 'It support', 'important', 'Thinroot', 'lkjhgfddsf', 'ticketIssueImage-5eb5ef15-22de-4ead-b4db-7ee526304823.png', 'ticketIssueDoc-60b1b17a-141c-4e61-a9bc-3ace8052bae7.plain', 4, 'InProgress', 0, '2022-10-20 09:33:25.764', NULL, '2022-10-20 09:33:25.764');
...
(10, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjIsImlhdCI6MTY2NjAxOTc3OCwiZXhwIjoxNjY4NjExNzc4LCJ0eXBlIjoicmVmcmVzaCJ9.bFNVw94LTtnOfhdeV1mj8dNg8o5OssO6cm6WVsc3vMQ', 2, 'refresh', '2022-11-16 15:16:18', 0, 2, '2022-10-17 15:16:18.390', NULL, '2022-10-17 15:16:18.390'),
(11, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjIsImlhdCI6MTY2NjA4MTE3OSwiZXhwIjoxNjY4NjczMTc5LCJ0eXBlIjoicmVmcmVzaCJ9._XTNsU43TPA4LxO2b1uFRse9ejxQjff1ke7zQ2BFnFU', 2, 'refresh', '2022-11-17 08:19:39', 0, 2, '2022-10-18 08:19:39.111', NULL, '2022-10-18 08:19:39.111'),
(17, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjIsImlhdCI6MTY2NjE3MDEzNCwiZXhwIjoxNjY4NzYyMTM0LCJ0eXBlIjoicmVmcmVzaCJ9.zXXiRYjMlAyI6s037gG7u6CyqGTlZXkl4Hc1_rcD_Ow', 2, 'refresh', '2022-11-18 09:02:14', 0, 2, '2022-10-19 09:02:14.182', NULL, '2022-10-19 09:02:14.182'),
(22, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjIsImlhdCI6MTY2NjI1ODA2OCwiZXhwIjoxNjY4ODUwMDY4LCJ0eXBlIjoicmVmcmVzaCJ9.mLZDpmJmCnawv0xwijEm6P8WhuHQAoAVjmb-Nfl1L2I', 2, 'refresh', '2022-11-19 09:27:48', 0, 2, '2022-10-20 09:27:48.031', NULL, '2022-10-20 09:27:48.031');
...
--
-- Indexes for table `goals_users`
--
ALTER TABLE `goals_users`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `goal_target_items`
--
ALTER TABLE `goal_target_items`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `goal_target_users`
--
ALTER TABLE `goal_target_users`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `list_checklist`
--
ALTER TABLE `list_checklist`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `list_sub_tasks`
--
ALTER TABLE `list_sub_tasks`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `list_task_attachements`
--
ALTER TABLE `list_task_attachements`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `goals_users`
--
ALTER TABLE `goals_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `goal_target_items`
--
ALTER TABLE `goal_target_items`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `goal_target_users`
--
ALTER TABLE `goal_target_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `list_checklist`
--
ALTER TABLE `list_checklist`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `list_sub_tasks`
--
ALTER TABLE `list_sub_tasks`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `list_task_attachements`
--
ALTER TABLE `list_task_attachements`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tokens`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=23;
