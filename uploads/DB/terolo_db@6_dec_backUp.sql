...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 06, 2022 at 07:04 AM
...
CREATE TABLE `customers` (
  ...
  `customersCompanyDetailsId` int(11) NOT NULL COMMENT 'Populate "id" field value from "customers_company_details" table',
  `customersPeopleId` int(11) NOT NULL COMMENT 'Populate "id" field value from "customers_people" table',
  `isDeleted` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'isDeleted value is "0: isVisible", "1: notVisible" on the data',
  `createdBy` int(11) UNSIGNED NOT NULL COMMENT 'Primary Key of "user_masters" table',
  `createdAt` datetime(3) NOT NULL DEFAULT current_timestamp(3),
  `updatedBy` int(11) UNSIGNED DEFAULT NULL COMMENT 'Primary Key of "user_masters" table',
  `updatedAt` datetime(3) NOT NULL DEFAULT current_timestamp(3)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Stores customers data';
...
CREATE TABLE `customers_company_details` (
  ...
  `companyClients` varchar(255) NOT NULL,
  `previousProjects` varchar(255) NOT NULL,
  ...
  `updatedBy` int(11) UNSIGNED DEFAULT NULL COMMENT 'Primary Key of "user_masters" table',
  `updatedAt` datetime(3) NOT NULL DEFAULT current_timestamp(3)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Stores customers_company_details data';

-- --------------------------------------------------------

--
-- Table structure for table `customers_people`
--

CREATE TABLE `customers_people` (
  `id` int(11) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `aboutProject` varchar(255) NOT NULL,
  `clients` varchar(255) NOT NULL,
  ...
  `updatedBy` int(11) UNSIGNED DEFAULT NULL COMMENT 'Primary Key of "user_masters" table',
  `updatedAt` datetime(3) NOT NULL DEFAULT current_timestamp(3)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Stores customers_people data';
...
--
-- Indexes for table `customers_people`
--
ALTER TABLE `customers_people`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `customers_people`
--
ALTER TABLE `customers_people`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
...
--
ALTER TABLE `tokens`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=93;
